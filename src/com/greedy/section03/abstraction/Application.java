...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * 현실 세계에서 불가능한 무생물이나 개념 같은 존재들도
		 * 하나의 조체로 자율 의사를 가지고 본인의 상태를 스스로 제어하고 행동한다는게 현실 세계와 다른 점이다.
		 * 이러한 기법을 의인화라고 하여 의인화는 곧 캡슐화이다.
		 *  */ 
		 ...
		 * 메세지를 수신하는 쪽은 수신자라고 한다.
		 * 수신자는 메세지를 전달 받아 그 메세지에 해당하는 내용을 처리하는 방법을 스스로 결정하고,
		 * 그 결정한 방법대로 처리할 명령어들을 순차젖ㄱ으로 기술한 것을 메소드라고 한다.
		 * */
		 ...
		 * 5. 브레이크를 밟을 떄 자동차가 달리는 중이 아니라면 이미 멈춰있는 상태라고 안내한다.
